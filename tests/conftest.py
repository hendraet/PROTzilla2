...
def evidence_peptide_df():
    df = pd.DataFrame(
        (
            ...
            ["Sample1", "Protein3", "SEQH", 7000000, "Unmodified", "_SEQH_", None, 0.00007, "Raw_File_1"],
            ["Sample1", "Protein4", "SEQI", 8000000, "Unmodified", "_SEQI_", None, 0.00008, "Raw_File_1"],
            ["Sample1", "Protein5", "SEQJ", 9000000, "Unmodified", "_SEQJ_", None, 0.00009, "Raw_File_1"],
            ["Sample2", "Protein1", "SEQK", 10000000, "Acetyl (Protein N-term)", "_(Acetyl (Protein N-term))SEQK_", None, 0.0001, "Raw_File_2"],
            ["Sample2", "Protein2", "SEQL", 11000000, "Unmodified", "_SEQL_", None, 0.00011, "Raw_File_2"],
            ["Sample2", "Protein3", "SEQM", 12000000, "Unmodified", "_SEQM_", None, 0.00012, "Raw_File_2"],
            ["Sample2", "Protein4", "SEQN", 13000000, "Unmodified", "_SEQN_", None, 0.00013, "Raw_File_2"],
            ["Sample2", "Protein5", "SEQO", 14000000, "Unmodified", "_SEQO_", None, 0.00014, "Raw_File_2"],
            ["Sample3", "Protein1", "SEQP", 15000000, "Unmodified", "_SEQP_", None, 0.00015, "Raw_File_3"],
            ["Sample3", "Protein2", "SEQQ", 16000000, "Unmodified", "_SEQQ_", None, 0.00016, "Raw_File_3"],
            ["Sample3", "Protein3", "SEQR", 17000000, "Unmodified", "_SEQR_", None, 0.00017, "Raw_File_3"],
            ["Sample3", "Protein4", "SEQS", 18000000, "Unmodified", "_SEQS_", None, 0.00018, "Raw_File_3"],
            ["Sample3", "Protein5", "SEQT", 19000000, "Unmodified", "_SEQT_", None, 0.00019, "Raw_File_3"],
            ["Sample4", "Protein1", "SEQU", 20000000, "Unmodified", "_SEQU_", None, 0.0002, "Raw_File_4"],
            ["Sample4", "Protein2", "SEQV", 21000000, "Unmodified", "_SEQV_", None, 0.00021, "Raw_File_4"],
            ["Sample4", "Protein3", "SEQW", 22000000, "Unmodified", "_SEQW_", None, 0.00022, "Raw_File_4"],
            ["Sample4", "Protein4", "SEQX", 23000000, "Unmodified", "_SEQX_", None, 0.00023, "Raw_File_4"],
        ),
        columns=[
            "Sample",
            "Protein ID",
